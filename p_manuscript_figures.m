...
% running the module to create figure 1
...
% running the module to create figure 2
...
% running the module to create figure 3
% figure 3 is the baseline simulation
